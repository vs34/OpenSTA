...
#line 25 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
...
#line 62 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
...
#line 49 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
namespace sta {
#line 160 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
...
#line 93 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                    { delete (yysym.value.string); }
#line 373 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
        break;
...
#line 100 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                                        {}
#line 644 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 5: // header_stmt: '(' SDFVERSION QSTRING ')'
#line 110 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                                   { delete (yystack_[1].value.string); }
#line 650 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 6: // header_stmt: '(' DESIGN QSTRING ')'
#line 111 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                               { delete (yystack_[1].value.string); }
#line 656 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 7: // header_stmt: '(' DATE QSTRING ')'
#line 112 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                             { delete (yystack_[1].value.string); }
#line 662 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 8: // header_stmt: '(' VENDOR QSTRING ')'
#line 113 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                               { delete (yystack_[1].value.string); }
#line 668 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 9: // header_stmt: '(' PROGRAM QSTRING ')'
#line 114 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                                { delete (yystack_[1].value.string); }
#line 674 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 10: // header_stmt: '(' PVERSION QSTRING ')'
#line 115 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                                 { delete (yystack_[1].value.string); }
#line 680 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 11: // header_stmt: '(' DIVIDER hchar ')'
#line 116 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                              { reader->setDivider((yystack_[1].value.character)); }
#line 686 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 12: // header_stmt: '(' VOLTAGE triple ')'
#line 117 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                               { reader->deleteTriple((yystack_[1].value.triple)); }
#line 692 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 15: // header_stmt: '(' PROCESS QSTRING ')'
#line 120 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                                { delete (yystack_[1].value.string); }
#line 698 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 18: // header_stmt: '(' TEMPERATURE triple ')'
#line 123 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                                   { reader->deleteTriple((yystack_[1].value.triple)); }
#line 704 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 20: // header_stmt: '(' TIMESCALE NUMBER ID ')'
#line 125 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                                    { reader->setTimescale((yystack_[2].value.number), (yystack_[1].value.string)); }
#line 710 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 21: // hchar: '/'
#line 130 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { (yylhs.value.character) = '/'; }
#line 716 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 22: // hchar: '.'
#line 132 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { (yylhs.value.character) = '.'; }
#line 722 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 23: // number_opt: %empty
#line 135 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
            { (yylhs.value.number_ptr) = nullptr; }
#line 728 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 24: // number_opt: NUMBER
#line 136 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                { (yylhs.value.number_ptr) = new float((yystack_[0].value.number)); }
#line 734 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 27: // cell: '(' CELL celltype cell_instance timing_specs ')'
#line 146 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->cellFinish(); }
#line 740 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 28: // celltype: '(' CELLTYPE QSTRING ')'
#line 151 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->setCell((yystack_[1].value.string)); }
#line 746 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 29: // cell_instance: '(' INSTANCE ')'
#line 156 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->setInstance(nullptr); }
#line 752 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 30: // cell_instance: '(' INSTANCE '*' ')'
#line 158 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->setInstanceWildcard(); }
#line 758 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 31: // cell_instance: '(' INSTANCE path ')'
#line 160 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->setInstance((yystack_[1].value.string)); }
#line 764 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 38: // $@1: %empty
#line 179 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->setInIncremental(false); }
#line 770 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 40: // $@2: %empty
#line 182 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->setInIncremental(true); }
#line 776 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 44: // path: ID
#line 192 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { (yylhs.value.string) = reader->unescaped((yystack_[0].value.string)); }
#line 782 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 45: // path: path hchar ID
#line 194 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { (yylhs.value.string) = reader->makePath((yystack_[2].value.string), reader->unescaped((yystack_[0].value.string))); }
#line 788 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 46: // del_def: '(' IOPATH port_spec port_instance retains delval_list ')'
#line 199 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->iopath((yystack_[4].value.port_spec), (yystack_[3].value.string), (yystack_[1].value.delval_list), nullptr, false); }
#line 794 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 47: // del_def: '(' CONDELSE '(' IOPATH port_spec port_instance retains delval_list ')' ')'
#line 202 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->iopath((yystack_[5].value.port_spec), (yystack_[4].value.string), (yystack_[2].value.delval_list), nullptr, true); }
#line 800 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 48: // del_def: '(' COND EXPR_OPEN_IOPATH port_spec port_instance retains delval_list ')' ')'
#line 205 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
...
#line 862 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 62: // $@4: %empty
#line 243 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                 { reader->setInTimingCheck(true); }
#line 868 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 63: // tchk_def: '(' HOLD $@4 port_tchk port_tchk value ')'
#line 245 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->timingCheck(sta::TimingRole::hold(), (yystack_[3].value.port_spec), (yystack_[2].value.port_spec), (yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 876 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 64: // $@5: %empty
#line 248 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                      { reader->setInTimingCheck(true); }
#line 882 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 65: // tchk_def: '(' SETUPHOLD $@5 port_tchk port_tchk value value ')'
#line 250 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
...
#line 890 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 66: // $@6: %empty
#line 253 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                     { reader->setInTimingCheck(true); }
#line 896 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 67: // tchk_def: '(' RECOVERY $@6 port_tchk port_tchk value ')'
#line 255 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->timingCheck(sta::TimingRole::recovery(),(yystack_[3].value.port_spec),(yystack_[2].value.port_spec),(yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 904 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 68: // $@7: %empty
#line 258 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                    { reader->setInTimingCheck(true); }
#line 910 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 69: // tchk_def: '(' REMOVAL $@7 port_tchk port_tchk value ')'
#line 260 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->timingCheck(sta::TimingRole::removal(),(yystack_[3].value.port_spec),(yystack_[2].value.port_spec),(yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 918 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 70: // $@8: %empty
#line 263 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                   { reader->setInTimingCheck(true); }
#line 924 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 71: // tchk_def: '(' RECREM $@8 port_tchk port_tchk value value ')'
#line 265 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
...
#line 932 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 72: // $@9: %empty
#line 268 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                 { reader->setInTimingCheck(true); }
#line 938 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 73: // tchk_def: '(' SKEW $@9 port_tchk port_tchk value ')'
#line 271 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->timingCheck(sta::TimingRole::skew(),(yystack_[2].value.port_spec),(yystack_[3].value.port_spec),(yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 946 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 74: // $@10: %empty
#line 274 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                  { reader->setInTimingCheck(true); }
#line 952 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 75: // tchk_def: '(' WIDTH $@10 port_tchk value ')'
#line 276 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->timingCheckWidth((yystack_[2].value.port_spec), (yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 960 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 76: // $@11: %empty
#line 279 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                   { reader->setInTimingCheck(true); }
#line 966 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 77: // tchk_def: '(' PERIOD $@11 port_tchk value ')'
#line 281 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { reader->timingCheckPeriod((yystack_[2].value.port_spec), (yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 974 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 78: // $@12: %empty
#line 284 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
                     { reader->setInTimingCheck(true); }
#line 980 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 79: // tchk_def: '(' NOCHANGE $@12 port_tchk port_tchk value value ')'
#line 286 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
...
#line 1085 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 95: // triple: number_opt ':' NUMBER ':' number_opt
#line 343 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        {
...
#line 1094 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 96: // triple: number_opt ':' number_opt ':' NUMBER
#line 348 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        {
...
#line 1103 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 97: // NUMBER: FNUMBER
#line 355 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { (yylhs.value.number) = (yystack_[0].value.number); }
#line 1109 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 98: // NUMBER: DNUMBER
#line 357 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { (yylhs.value.number) = static_cast<float>((yystack_[0].value.integer)); }
#line 1115 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;

  case 99: // NUMBER: '-' DNUMBER
#line 359 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
        { (yylhs.value.number) = static_cast<float>(-(yystack_[0].value.integer)); }
#line 1121 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
    break;


#line 1125 "/pkg/git/OpenSTA/cmake/SdfParse.cc"
...
#line 1655 "/pkg/git/OpenSTA/cmake/SdfParse.cc"

#line 362 "/pkg/git/OpenSTA/sdf/SdfParse.yy"
