...
#line 25 "/pkg/git/OpenSTA/power/SaifParse.yy"
...
#line 65 "/pkg/git/OpenSTA/cmake/SaifParse.cc"


#include "SaifParse.hh"

// Second part of user prologue.
#line 85 "/pkg/git/OpenSTA/power/SaifParse.yy"


#line 74 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
...
#line 52 "/pkg/git/OpenSTA/power/SaifParse.yy"
namespace sta {
#line 168 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
...
#line 91 "/pkg/git/OpenSTA/power/SaifParse.yy"
                                         {}
#line 642 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 5: // header_stmt: '(' SAIFVERSION QSTRING ')'
#line 100 "/pkg/git/OpenSTA/power/SaifParse.yy"
                                    { sta::stringDelete((yystack_[1].value.string)); }
#line 648 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 6: // header_stmt: '(' DIRECTION QSTRING ')'
#line 101 "/pkg/git/OpenSTA/power/SaifParse.yy"
                                  { sta::stringDelete((yystack_[1].value.string)); }
#line 654 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 7: // header_stmt: '(' DESIGN QSTRING ')'
#line 102 "/pkg/git/OpenSTA/power/SaifParse.yy"
                               { sta::stringDelete((yystack_[1].value.string)); }
#line 660 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 8: // header_stmt: '(' DESIGN ')'
#line 103 "/pkg/git/OpenSTA/power/SaifParse.yy"
                       { }
#line 666 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 9: // header_stmt: '(' DATE QSTRING ')'
#line 104 "/pkg/git/OpenSTA/power/SaifParse.yy"
                             { sta::stringDelete((yystack_[1].value.string)); }
#line 672 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 10: // header_stmt: '(' VENDOR QSTRING ')'
#line 105 "/pkg/git/OpenSTA/power/SaifParse.yy"
                               { sta::stringDelete((yystack_[1].value.string)); }
#line 678 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 11: // header_stmt: '(' PROGRAM_NAME QSTRING ')'
#line 106 "/pkg/git/OpenSTA/power/SaifParse.yy"
                                     { sta::stringDelete((yystack_[1].value.string)); }
#line 684 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 12: // header_stmt: '(' VERSION QSTRING ')'
#line 107 "/pkg/git/OpenSTA/power/SaifParse.yy"
                                { sta::stringDelete((yystack_[1].value.string)); }
#line 690 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 13: // header_stmt: '(' DIVIDER hchar ')'
#line 108 "/pkg/git/OpenSTA/power/SaifParse.yy"
                              { reader->setDivider((yystack_[1].value.character)); }
#line 696 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 14: // header_stmt: '(' TIMESCALE UINT ID ')'
#line 109 "/pkg/git/OpenSTA/power/SaifParse.yy"
                                  { reader->setTimescale((yystack_[2].value.uint), (yystack_[1].value.string)); }
#line 702 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 15: // header_stmt: '(' DURATION UINT ')'
#line 110 "/pkg/git/OpenSTA/power/SaifParse.yy"
                              { reader->setDuration((yystack_[1].value.uint)); }
#line 708 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 16: // hchar: '/'
#line 115 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.character) = '/'; }
#line 714 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 17: // hchar: '.'
#line 117 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.character) = '.'; }
#line 720 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 18: // $@1: %empty
#line 122 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { reader->instancePush((yystack_[0].value.string)); }
#line 726 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 19: // instance: '(' INSTANCE ID $@1 instance_contents ')'
#line 124 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { reader->instancePop(); }
#line 732 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 20: // $@2: %empty
#line 126 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { reader->instancePush((yystack_[1].value.string)); }
#line 738 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 21: // instance: '(' INSTANCE QSTRING ID $@2 instance_contents ')'
#line 128 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { reader->instancePop(); }
#line 744 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 30: // net: '(' ID state_durations ')'
#line 150 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { reader->setNetDurations((yystack_[2].value.string), (yystack_[1].value.state_durations)); }
#line 750 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 34: // state_durations: '(' state UINT ')'
#line 164 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state_durations)[static_cast<int>((yystack_[2].value.state))] = (yystack_[1].value.uint); }
#line 756 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 35: // state_durations: state_durations '(' state UINT ')'
#line 166 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state_durations)[static_cast<int>((yystack_[2].value.state))] = (yystack_[1].value.uint); }
#line 762 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 36: // state: T0
#line 171 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state) = sta::SaifState::T0; }
#line 768 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 37: // state: T1
#line 173 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state) = sta::SaifState::T1; }
#line 774 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 38: // state: TX
#line 175 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state) = sta::SaifState::TX; }
#line 780 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 39: // state: TZ
#line 177 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state) = sta::SaifState::TZ; }
#line 786 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 40: // state: TB
#line 179 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state) = sta::SaifState::TB; }
#line 792 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 41: // state: TC
#line 181 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state) = sta::SaifState::TC; }
#line 798 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;

  case 42: // state: IG
#line 183 "/pkg/git/OpenSTA/power/SaifParse.yy"
        { (yylhs.value.state) = sta::SaifState::IG; }
#line 804 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
    break;


#line 808 "/pkg/git/OpenSTA/cmake/SaifParse.cc"
...
#line 1223 "/pkg/git/OpenSTA/cmake/SaifParse.cc"

#line 186 "/pkg/git/OpenSTA/power/SaifParse.yy"
